...
<img src="raster/images/ShadedTriangle.png" width="250"></img>
...
Shaded triangles can be drawn by applying the existing interpolations techniques to hue/intensity values assigned to each vertex.
